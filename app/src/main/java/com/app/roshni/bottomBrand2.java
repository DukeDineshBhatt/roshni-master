...
public class bottomBrand2 extends BottomSheetDialogFragment {
    ...
    static bottomBrand2 newInstance() {
        ...
        allJobs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bid.length() > 0)
                {
                    ...
                    Intent intent = new Intent(getContext() , ContractorJobByCompany.class);
