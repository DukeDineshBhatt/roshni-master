...
public class ContractorJobByCompany extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contractor_job_by_company);
    ...
    public void onResume() {
        ...
        Call<allWorkContrJobBean> call = cr.getAllContractorJobs(bid , "Active" , "");
