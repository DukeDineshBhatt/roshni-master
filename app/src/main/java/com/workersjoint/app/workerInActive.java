...
public class workerInActive extends Fragment {
    ...
    public void onResume() {
        ...
        Call<allWorkContrJobBean> call = cr.getAllWorkerJobs(SharePreferenceUtils.getInstance().getString("user_id") , "Inactive" , sort);
