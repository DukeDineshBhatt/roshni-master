...
public class Feedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.give_feedback));
            ...
            public void onClick(View v) {
                ...
                if (s.length() > 0)
                {
                    if (b.length() > 0)
                    {
                        ...
                        Call<contractorBean> call = cr.giveFeedback(
                    ...
                    {
                        Toast.makeText(Feedback.this, "Invalid body", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(Feedback.this, "Invalid subject", Toast.LENGTH_SHORT).show();
                }
